...
const technologies = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" className="w-8 h-8" fill="currentColor">
        <path d="M12 0C5.372 0 0 5.372 0 12s5.372 12 12 12 12-5.372 12-12S18.628 0 12 0zm0 2.4c5.302 0 9.6 4.298 9.6 9.6s-4.298 9.6-9.6 9.6S2.4 17.302 2.4 12 6.698 2.4 12 2.4zm0 1.8a7.8 7.8 0 100 15.6 7.8 7.8 0 000-15.6zm0 2.4a5.4 5.4 0 110 10.8 5.4 5.4 0 010-10.8zm0 2.4a3 3 0 100 6 3 3 0 000-6z" />
      </svg>
    ),
  },
  {
